...
exports.errors = exports.wyr = exports.quiz = exports.joke = exports.dyk = exports.cat = exports.ball = exports.greetings = void 0;
...
const progressBar = (0, loadingBar_1.default)("Loading Data     | {bar} | {value}/{total} {filename}");
...
for (const [key, filePath] of Object.entries(files)) {
    ...
    progressBar.increment(1, { filename: path_1.default.basename(filePath) });
}
progressBar.stop();
